    ...
    @if ($emergencies->isNotEmpty())
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-primary view-btn" 
                                                        ...
                                                        data-requisition-id="{{ $emergency->requisition_id }}" 
                                                        data-items="{{ json_encode($emergency->items) }}">
                                                        View
                                                    </button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel-{{ $emergency->requisition_id }}">Confirm Delete</h5>
        ...
        <div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewModalLabel">Emergency Requisition Items</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
