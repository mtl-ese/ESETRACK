<x-layout>
    ...
    <div class="d-flex justify-content-between mb-1">
        <x-back-link style="max-hei ght: fit-content;" href="{{ route('acquired.index') }}">Back</x-back-link>
        ...
        <div class="col-12">
            <div class="card bg-light bg-opacity-50">
                <div class="card-header border-bottom-1">
                    <h3 class="card-title mt-2 text-lg"><strong>Acquired Purchase Requisition ID:
                            {{ $items[0]->acquired->purchase_requisition_id }}</strong></h3>
                    <h3 class="card-title mt-2 text-lg"><strong>Project Description:
                            {{ $items[0]->acquired->requisition->project_description }}</strong></h3>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark fw-bold" style="background-color: rgba(255, 174, 0,0.75);">
                                        {{ $item->purchaseItem->getBalanceAttribute() }}
                                    </td>
                                </tr>
