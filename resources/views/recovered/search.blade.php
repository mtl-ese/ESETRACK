<x-layout>
    <x-success></x-success>
    <x-error></x-error>
    <x-back-link href="{{ route('recovered.index') }}">Back</x-back-link>

    @if ($items->isNotEmpty())
        <h2 class="mb-4 text-center">Recovered Materials Storage</h2>
        <h4 class="mb-4 text-center">Search results for "{{ $query }}"</h4>

        <div class="d-flex justify-content-center">

            <form class="input-group mb-3" style="max-width: 400px;" method="post" action="{{ route('recovered.search') }}">
                @csrf
...
<!-- 
        ...
        <div class="table-responsive shadow">
            <table class="table table-bordered table-hover text-center" id="recovered_table">
    ...
    @else
        <h2 class="mb-4 text-center">No Recovery Stores records</h2>
