<x-layout>
        ...
        <div class="col-12">
            <div class="card bg-light bg-opacity-50">
                <div class="card-header border-bottom-1">
                    <h3 class="card-title mt-2 text-lg"><strong>Recovered Materials Storage</strong></h3>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">
                                        ...
                                        <a href="{{ route('serial.index', $item->id) }}"
    ...
    @else
    <h2 class="mb-4 text-center">No Recovered Requisition Records</h2>
