...
<head>
   @vite(['resources/css/app.css', 'resources/js/app.js'])
    ...
    overflow: auto !important; /* Ensure scrolling works if needed */
        }
...
.background-image {
    ...
    z-index: -1; /* Ensure it stays in the background */
        ...
        body.modal-open {
            z-index: 1050; /* Ensure the modal stays above the background */
}
...
/* Modal backdrop */
.modal-backdrop {
    z-index: 999; /* Make sure the backdrop doesn't overlap the background */
}
        ...
        .login-container {
            ...
            z-index: 1000; /* Make sure the login modal stays on top of other content */
        }
        ...
        .login-right {
            flex: 1;
            padding: 40px; /* Reduced padding for better responsiveness */
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        .forgot-password {
            text-align: right; /* Aligns the forgot password link to the right */
        }
    </style>
</head>
<body>
                ...
                <form action="{{ route('login') }}" method="post" class="login-form">
                    ...
                    <div class="password mb-3">
                        <div class="input-group">
                            <input type="password" name="password" id="signin-password" class="form-control" placeholder="Password" required>
