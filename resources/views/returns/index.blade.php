                                            ...
                                            @if(Auth::user()->isAdmin === 1 || Auth::user()->isSuperAdmin === 1)
                                                <td class="text-center">
                                                    <form id="delete-form-{{ $store->store_requisition_id }}"
                                                        action="{{ route('returns.destroy', $store->store_requisition_id) }}"
                                                        method="POST">
                                                        @csrf
                                                    ...
                                                    <div class="modal fade" id="deleteModal-{{ $store->store_requisition_id }}"
                                                        tabindex="-1"
                                                        aria-labelledby="deleteModalLabel-{{ $store->store_requisition_id }}"
                                                        aria-hidden="true">
