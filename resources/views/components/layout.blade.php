        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2" title="Create">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><x-nav-link :active="request()->routeIs('create.purchase')"
                            href="{{ route('create.purchase') }}" class="dropdown-item"
                            title="create a new purchase requisition">Purchase</x-nav-link></li>
                    <li><x-nav-link :active="request()->routeIs('create.store')" href="{{ route('create.store') }}"
                            class="dropdown-item" title="create a new store requisition">Store</x-nav-link></li>
                    <li><x-nav-link :active="request()->routeIs('recovery.create')"
                            href="{{ route('recovery.create') }}" class="dropdown-item"
                            title="create a new recovery requisition">Recovery</x-nav-link></li>
                    <li><x-nav-link :active="request()->routeIs('returns.create')" href="{{ route('returns.create') }}"
                            class="dropdown-item" title="create a new store return">Store Return</x-nav-link></li>
                    <li><x-nav-link :active="request()->routeIs('emergencyCreate')"
                            href="{{ route('emergencyCreate') }}" class="dropdown-item"
                            title="create a new emergency requisition">Emergency</x-nav-link></li>
                    <li>
            ...
            <li class="nav-item mb-2" title="Returns Storage">
                <x-nav-link :active="request()->routeIs('return.index')" href="{{ route('return.index') }}">
                    <img src="{{ asset('images/return-storage.gif') }}" alt="Return"
